...
function MakeswiftOrderList(props: Props) {
  return <OrderList {...props} customerId={props.customerId?.toString()} />;
}

runtime.registerComponent(MakeswiftOrderList as any, {
  type: 'buyer-portal-order-list',
  label: 'Buyer Portal / Order List',
  props: {
    className: Style(),
    customerId: Combobox({
      label: 'Customer',
